                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Order Details<span class="mt-3 mb-3"><b>OrderNumber: {{$order->order_number}}</b></span>
                                        <br><small>Click <a href=" {{ route('order.resendemail', $order->id)}}"  }}>here</a> to resend order email.</small>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 " style="    background-color: rgb(70, 69, 69);">
                                                <span>
                                    ...
                                    <div class="modal-footer no-bd">
                                        <form action="{{route('order.delivered')}}" method="post" enctype="multipart/form-data">
                                            ...
                                            @else
                                              <input type="hidden"  class="form-control" name="orderid" value="{{$order->id}}" id="" aria-describedby="helpId" placeholder="">

                                            <button type="submit" id="addRowButton" class="btn btn-submit btn-primary">Order Complete</button>

                                            @endif
                                        </form>
                                            <a href="{{route('admin.orders')}}"><button class="btn btn-danger">Back</button></a>
                                        </div>
