            ...
            <div class="card    product-wrapper product-border ">
                <div class="product-img-3">
                    ...
                    <div class="product-action-right">
                        <a class="animate-right"  data-target="#exampleModal{{$product->id}}" data-toggle="modal" title="Quick View">
                        ...
                        @else
                            <a class="animate-right" href="{{route('cart.add',$product->id)}}"    title="Add To Cart">
                                <button class="animate-right btn btn-icon btn-success">
                                    <i class="fas fa-cart-plus"></i>
                                </button>
                            </a>
                        ...
                        @if (isset($wish))
                            <a class="animate-right" href="{{route('wishlist.delete',$product->id)}}" data-target="#exampleModal{{$product->id}}" title="Remove From Wishlist">
                        ...
                        @else
                            ...
                            <a class="animate-right" href="{{route('wishlist.add',$product->id)}}" data-target="#exampleModal{{$product->id}}" title="Add To Wishlist">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-xl-7">
                                    ...
                                    <div class="col-12">
                                        @php
                                            ...
                                            $cover = substr_replace($cover ,"",-1);
                                        @endphp
                                        <img load="lazy" src="{{asset('storage/uploads/'.$product->shop->user->id.'/'.$cover)}}" onerror="this.src='{{asset('assets/img/494.jpg')}}'" alt="..." class="avatar-img rounded">
