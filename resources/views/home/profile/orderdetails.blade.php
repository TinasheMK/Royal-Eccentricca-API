                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title"><span class="mt-3 mb-3"><b>OrderNumber: {{$order->order_number}}</b></span>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 " style="    background-color: antiquewhite;">
                                                <span>
                                                    <h4 class="mt-4"><small>Status:</small> @if ($order->status)
                                    ...
                                    <div class="modal-footer no-bd">
                                            ...
                                            <a href="{{route('profile')}}"><button class="btn btn-danger">Back</button></a>
                                        </div>
